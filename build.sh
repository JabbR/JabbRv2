...
#rc=$?; if [[ $rc != 0 ]]; then exit $rc; fi
#cd ../../
kpm pack src/JabbR --no-source --out artifacts/build/jabbr --runtime KRE-Mono.1.0.0-beta2 2>&1 | tee buildlog
...
chmod +x artifacts/build/jabbr/approot/packages/KRE-Mono.1.0.0-beta2/bin/klr
