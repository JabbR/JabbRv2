...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/henrik/GitHub/Forks/JabbRv2/src/JabbR/node_modules/react-hot-loader/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/henrik/GitHub/Forks/JabbRv2/src/JabbR/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } (function () {
	...
	var _componentsAccountLoginJs = __webpack_require__(1);

	var NotificationHandler = _interopRequire(_componentsAccountLoginJs);

	var AccountHandler = _interopRequire(__webpack_require__(2));

	var HelpHandler = _interopRequire(_componentsAccountLoginJs);

	var AdminHandler = _interopRequire(_componentsAccountLoginJs);

	var LoginHandler = _interopRequire(_componentsAccountLoginJs);

	var App = React.createClass({
	  displayName: "App",

	  render: function render() {
	    return React.createElement("div", null, React.createElement("ul", { className: "nav pull-left", style: { paddingRight: "75px" } }, React.createElement("li", null, React.createElement(Link, { to: "app" }, "Home")), React.createElement("li", null, React.createElement(Link, { to: "notifications" }, "Notifications")), React.createElement("li", null, React.createElement(Link, { to: "account" }, "Account")), React.createElement("li", null, React.createElement(Link, { to: "help" }, "Help")), React.createElement("li", null, React.createElement(Link, { to: "admin" }, "Admin")), React.createElement("li", null, React.createElement(Link, { to: "login" }, "Login"))), React.createElement(RouteHandler, null));
	  }
	});

	var routes = React.createElement(Route, { name: "app", path: "/", handler: App }, React.createElement(Route, { name: "notifications", path: "/notifications", handler: NotificationHandler }), React.createElement(Route, { name: "account", path: "/account", handler: AccountHandler }), React.createElement(Route, { name: "help", path: "/help", handler: HelpHandler }), React.createElement(Route, { name: "admin", path: "/admin", handler: AdminHandler }), React.createElement(Route, { name: "login", path: "/login", handler: LoginHandler }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Account = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement("div", null, "Welcome to your account");
	    }
	});

	module.exports = Account;

	/* REACT HOT LOADER */ })(); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/henrik/GitHub/Forks/JabbRv2/src/JabbR/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Account.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RouteHandler = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScrollHistory = __webpack_require__(53);
	var createRoutesFromReactChildren = __webpack_require__(23);
	var isReactChildren = __webpack_require__(54);
	var Transition = __webpack_require__(55);
	var PropTypes = __webpack_require__(47);
	var Redirect = __webpack_require__(56);
	var History = __webpack_require__(19);
	var Cancellation = __webpack_require__(57);
